...
var module = { 0: "--", 1: "A3", 2: "A4", 3: "A5", 4: "A6", 5: "A7", 6: "A8", 7: "A9", 8: "A10", 9: "A11", 10: "A12", 11: "A13", 12: "A14", 13: "A15", 14: "A16" };
var en = { 0: "нет", 1: "да" };
	...
	$("#save").off("click").on("click", function () {
		if (navigator.msSaveOrOpenBlob) {
			navigator.msSaveOrOpenBlob(new Blob([JSON.stringify(data, null, 2).replace(/&#x2d;/g, "-")], {
				type: "text/plain"
			}), "DE1-boilerConfig" + new Date().toLocaleDateString() + new Date().toLocaleTimeString() + ".tconf");
		} else {
			const a = document.createElement("a");
			a.href = URL.createObjectURL(new Blob([JSON.stringify(data, null, 2).replace(/&#x2d;/g, "-")], {
				type: "text/plain"
			}));
			a.setAttribute("download", "DE1-boilerConfig_" + new Date().toLocaleDateString() + "_" + new Date().toLocaleTimeString() + ".tconf");
